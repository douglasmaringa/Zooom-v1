...
const Settings = ({navigation}) => {
  ...
  return (
   ...
   <Text style={{color:'white',marginTop:10,fontWeight:'700',textAlign:'center'}}>The Zooom Settings</Text>

    </View>

    <View style={{display:'flex',flexDirection:'row',marginHorizontal:width/3.5}}>
